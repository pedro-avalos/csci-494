...
\textcquote{barlow:wine}[.]{incapable of confinement or exclusive appropriation}
...
as \textcquote{merriam-webster:piracy}[.]{%
...
\textquote[][.]{%
  \textins*{l}et the wise hear and increase in learning, and the one who
...
According to a survey conducted by MUSO, \textcquote{muso:about}[,]{%
  a data company that provides the most complete and trusted view of global
  piracy and unlicensed media consumption%
} the most common reasons that users pirate is \textcquote{vice:pirates}[.]{%
...
hypothesized, like other researchers, that \textquote{cyber criminals would target
...
As the Psalmist writes, \textquote{It is better to take refuge in the Lord than
